...
CREATE TABLE CLIENTE_VEICULO (
    ...
    CONSTRAINT CLIENTE_VEICULO_IDCLI_FK FOREIGN KEY(IDCLI) REFERENCES CLIENTE,
    CONSTRAINT CLIENTE_VEICULO_IDVEIC_FK FOREIGN KEY(IDVEIC) REFERENCES VEICULO,
    
    CONSTRAINT CLIENTE_VEICULO_PK PRIMARY KEY(IDCLI, IDVEIC)
);
